...
const SEED: Array<{ ticker: string; name: string; stockSymbol: string; feeShare: number }> = [
  { ticker: 'TSLR', name: 'Tesla Rocket', stockSymbol: 'TSLA', feeShare: 0.4 },
  { ticker: 'NVDX', name: 'Nvidia Max', stockSymbol: 'NVDA', feeShare: 0.5 },
  { ticker: 'APEX', name: 'Apple Prime', stockSymbol: 'AAPL', feeShare: 0.35 },
  { ticker: 'MSTX', name: 'MicroStack', stockSymbol: 'MSTR', feeShare: 0.6 },
  { ticker: 'GMEZ', name: 'GameZone', stockSymbol: 'GME', feeShare: 0.55 },
  { ticker: 'COIX', name: 'Coinbase X', stockSymbol: 'COIN', feeShare: 0.45 },
  { ticker: 'AMZG', name: 'Amazon Gold', stockSymbol: 'AMZN', feeShare: 0.3 },
  { ticker: 'PLTX', name: 'Palantir X', stockSymbol: 'PLTR', feeShare: 0.5 },
  { ticker: 'HOOD', name: 'Hood Money', stockSymbol: 'HOOD', feeShare: 0.4 },
  { ticker: 'META9', name: 'Meta Nine', stockSymbol: 'META', feeShare: 0.35 },
]
...
export function getCoins(): Coin[] {
  return SEED.map((s, i) => {
    ...
    return buildCoin(s.ticker, s.name, stock, s.feeShare, i)
  })
}
